...
const nativeApi: ElectronApiLike = {
  ...
  reorderConnections: (connectionIds) => tauriInvoke<void>('reorder_connections', { connectionIds }),
  ...
  exportAllData: (options) => tauriInvoke<ExportDataResult<any>>('export_all_data', { options }),
